    ...
    <div className="mx-auto max-w-3xl px-6 py-24">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        {[
          ...
          { href: "/espace-entreprise/messages", label: "Messages", desc: "Échanger avec les joueurs" },
          { href: "/espace-entreprise/equipe", label: "Mon équipe", desc: "Le roster confirmé, édition par édition" },
          { href: "/espace-entreprise/vitrines", label: "Vitrines d'équipe", desc: "Composer et publier un groupe nommé" },
