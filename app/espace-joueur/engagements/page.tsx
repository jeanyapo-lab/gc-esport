...
const statutLabels: Record<string, string> = {
  ...
  en_attente_signature: "En attente de ton document",
  valide: "Validé",
...
export default function JoueurEngagementsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-24">
      ...
      <h1 className="mt-4 font-display text-4xl">Mes engagements</h1>
